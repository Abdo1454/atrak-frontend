    ...
    <header className="flex flex-col gap-4 border-b bg-white px-6 py-5 shadow-sm md:flex-row md:items-center md:justify-between">
      ...
      <div>
        ...
        <p className="mt-1 text-gray-500">
          استمتع بإدارة حسابك وتتبع طلباتك بكل سهولة.
        </p>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative hidden md:block">
          ...
          <input
            type="text"
            placeholder="ابحث..."
            className="w-72 rounded-xl border border-gray-200 py-2 pl-10 pr-4 outline-none transition focus:border-violet-600"
          />
        </div>
        ...
        <div className="flex items-center gap-3 rounded-xl bg-violet-50 px-3 py-2">
          <UserCircle size={38} className="text-violet-700" />
